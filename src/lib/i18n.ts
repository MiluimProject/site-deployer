...
export const translations: Record<Lang, Translation> = {
  ...
  he: {
    ...
    whatWeDo: {
      ...
      p1: "חיים על הקו הינו הארכיון הדיגיטלי הראשון מסוגו, שנועד לתעד, לשמר ולשתף עדויות בלתי מסוננות של חיילי וחיילות מילואים, ובכך לבנות גשרים של הבנה, ריפוי וזיכרון בין דורי וקהילתי.",
