...
export const translations: Record<Lang, Translation> = {
  ...
  he: {
    ...
    whatWeDo: {
      ...
      p1: "מה אנחנו עושים? בונים את הארכיון הדיגיטלי במטרה לתעד, לשמר ולשתף את העדויות והסיפורים של לוחמי ולוחמות המילואים. בכך, לבנות גשר של הבנה, ריפוי וזיכרון עבור דורות העתיד, הקהילות בארץ ובתפוצות.",
      p2: "באמצעות שיחות בפורמט פודקאסט, המובלות על ידי מראיינים מקצועיים, אנו שואפים לתת לכל סיפור מקום. פודקאסטים הם כלי עכשווי לתיעוד היסטוריה שבעל-פה, המאפשרים שמירה על עדויות אישיות וחוויות ממקור ראשון. זהו מיזם תיעודי-חינוכי-חברתי שיחבר בין הדורות, יחזק את תחושת השייכות, וישמש ככלי משמעותי למחקר, חינוך וזיכרון קולקטיבי.",
    },
    news: {
      title: "בחדשות",
      articles: [
